          ...
          {!isOpened ? (
            ...
            <div className="animate-scale-in">
              ...
              <div className="z-10 font-caveat text-left mb-6 p-4 rounded-3xl border-5 border-pink-400 outline-black outline-0 outline-dashed print:border-none print:outline-none print:p-0 bg-[#f6e4ff] relative">
                ...
                <p className="text-lg print:text-sm leading-relaxed mb-4">There are going to be challenges in life, but that is okay. I wish the best for the both of us to support ourselves, achieve the goals we needed, and fulfill ourselves to grow together. I genuinely want us to improve ourselves, and support our hobbies and career. Remember, I want you to know that my love for you is completely unconditional. I love the person you are right now in this moment, and when I see you working hard towards a personal goal, it just makes me admire your strength even more. You are so powerful and self-sufficient, you inspire me and I will always be your BIGGEST FAN. Guess I am a cheerleader for you in your life.</p>
